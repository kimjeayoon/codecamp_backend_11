...
import {
  ...
  IAuthServiceLogin,
  IAuthServiceRestreAccessToken,
  IAuthServiceSetRefreshToken,
} from './interfaces/auths-service.interface';
...
export class AuthService {
  ...
  restoreAccessToken({ user }: IAuthServiceRestreAccessToken): string {
    return this.getAccessToken({ user });
  }
